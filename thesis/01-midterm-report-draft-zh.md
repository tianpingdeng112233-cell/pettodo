...
| 动画来源 | v3 rig pack:4 张姿势+骨架 | v2 逐帧生成 | 都能生成可辨认的宠物;v2 每只约 40 分钟且帧间漂移,v3 约 1 分钟且动作确定(第 3.5 节) |
...
v2 管线(第 3.2 节)靠"每一帧都单独生成一张图"来产出宠物:约 14 次串行生成、每只
约 40 分钟,帧间漂移见第 3.2 节,成品包还要人工发回给用户。这条路线已经退役。v3
...
**收尾 v3。**管线、代理、渲染器都在了(第 3.5 节);剩下的是生产与产品化:用同一条
